      ...
      <section className="mx-auto overflow-hidden rounded sm:mb-6 sm:w-1/2 xl:w-1/4">
        <div className="flex flex-col h-full justify-between px-6 py-4 text-center">
          <div>
            ...
            <p className="h-10 text-4xl text-center">
              $30
              <span className="text-lg text-gray-800"> / year</span>
            </p>
            <p className="mb-2 font-bold">For our supporters in 2017</p>
          ...
          <div>
            <small className="inline-block">
              Request handling up to 5 business days
            </small>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://goo.gl/forms/MOCnGsapwE5r5oQn1"
              className="block border-2 border-indigo-600 font-semibold hover:bg-indigo-600 hover:text-white mt-2 px-3 py-1 rounded shadow text-indigo-600 text-xl tracking-normal transition"
            >
              Get Discount!
            </a>
          </div>
      ...
      <section className="mx-auto overflow-hidden rounded sm:mb-6 sm:w-1/2 xl:w-1/4">
        <div className="flex flex-col h-full justify-between px-6 py-4 text-center">
          <div>
            ...
            <p className="mb-2 font-bold">For our supporters in 2018</p>
            <p className="text-base text-grey-darker">
          ...
          <div>
            <small className="inline-block">Use as long as staying a Patron</small>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.patreon.com/kalessil"
      ...
      <section className="mx-auto overflow-hidden rounded sm:mb-6 sm:w-1/2 xl:w-1/4">
        <div className="flex flex-col h-full justify-between px-6 py-4 text-center">
          <div>
            ...
            <p className="mb-2 font-bold">For individuals</p>
            <p className="text-base text-grey-darker">
          ...
          <div>
            <small className="inline-block">Free for PHP UGs leads</small>
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://goo.gl/forms/MOCnGsapwE5r5oQn1"
              className="bg-light-blue-vivid-500 block border-2 border-light-blue-vivid-500 font-semibold hover:bg-light-blue-vivid-600 hover:border-light-blue-vivid-600 mt-2 px-3 py-1 rounded shadow text-white text-xl tracking-normal transition"
            >
              Buy License!
            </a>
          </div>
      ...
      <section className="mx-auto overflow-hidden rounded sm:mb-6 sm:w-1/2 xl:w-1/4">
        <div className="flex flex-col h-full justify-between px-6 py-4 text-center">
          <div>
            ...
            <p className="mb-2 font-bold">For companies</p>
            <p className="text-base text-grey-darker">
